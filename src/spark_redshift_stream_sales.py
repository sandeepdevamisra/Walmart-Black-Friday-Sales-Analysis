...
spark = SparkSession.builder \
    ...
    .config("spark.jars", "<enter path to your JAR file>") \
    .getOrCreate()
...
cast_df = df.selectExpr("CAST(value AS STRING)") \
    .select(from_json(col("value"), schema).alias("data")) \
    .select("data.*")

# Redshift Configuration
redshift_jdbc_url = "jdbc:redshift://redshift-cluster-1.cunc0bqetsee.us-east-1.redshift.amazonaws.com:5439/dev"
redshift_table = "black_friday_sales.sales_transaction"
s3_temp_dir = "s3://black-friday-sales/sales_temp/"
